  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8FAFC', fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif", overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', width: 600, height: 600, background: 'radial-gradient(circle, rgba(255,153,51,0.15) 0%, transparent 60%)', top: '10%', right: '-5%', borderRadius: '50%', pointerEvents: 'none', animation: 'nv-pulse 6s infinite alternate' }} />
        <div style={{ position: 'absolute', width: 600, height: 600, background: 'radial-gradient(circle, rgba(13,148,136,0.12) 0%, transparent 70%)', bottom: '-10%', left: '-5%', borderRadius: '50%', pointerEvents: 'none', animation: 'nv-pulse 8s infinite alternate-reverse' }} />
        ...
        <img 
          ...
          style={{
            ...
            animation: 'nv-spin 120s linear infinite'
          }}
        />
        ...
        <h1 style={{
          ...
          {!animationComplete && (
            <span style={{ width: 4, height: 'clamp(50px, 9vw, 90px)', background: '#FF9933', display: 'inline-block', marginLeft: 5, animation: 'nv-blink 1s infinite' }} />
          )}
        </h1>
