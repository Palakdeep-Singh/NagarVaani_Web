...
db.welfareapplications.deleteMany({});
...
db.welfareapplications.insertMany([
  { citizen: "Rahul Kumar", scheme: "CM Widow Pension Scheme", doc: "Income Certificate", status: "Pending", createdAt: new Date(), updatedAt: new Date() },
  { citizen: "Sunita Devi", scheme: "Delhi Ladli Scheme", doc: "Birth Certificate", status: "Pending", createdAt: new Date(), updatedAt: new Date() },
  { citizen: "Mohan Lal", scheme: "Mukhyamantri Tirth Yatra Yojana", doc: "Age Proof Certificate", status: "Pending", createdAt: new Date(), updatedAt: new Date() }
]);
