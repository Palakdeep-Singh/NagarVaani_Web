...
import { GeneralMetric, HealthBed, HealthInventory, SchoolSmartBoard } from '../models/metrics.model';
...
export const seedDatabase = async (): Promise<void> => {
  try {
    ...
    await Officer.create([
      { id: "OFF-001", name: "Smt. Alice Vaz (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "New Delhi", resolutionRate: 92, avgResolutionTime: 4.2, activeComplaints: 2, completedComplaints: 28, rating: 4.5 },
      { id: "OFF-002", name: "Shri Amit Kumar (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "West Delhi", resolutionRate: 85, avgResolutionTime: 5.1, activeComplaints: 4, completedComplaints: 22, rating: 4.1 },
      { id: "OFF-003", name: "Smt. Cheshta Yadav (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "South Delhi", resolutionRate: 88, avgResolutionTime: 4.8, activeComplaints: 3, completedComplaints: 25, rating: 4.3 },
      { id: "OFF-004", name: "Shri Anil Bankar (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "Shahdara", resolutionRate: 90, avgResolutionTime: 4.6, activeComplaints: 1, completedComplaints: 24, rating: 4.4 },
      { id: "OFF-005", name: "Shri Vikram Singh (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "North East Delhi", resolutionRate: 79, avgResolutionTime: 6.2, activeComplaints: 7, completedComplaints: 19, rating: 3.8 },
      { id: "OFF-006", name: "Dr. Shalini Gupta", designation: "Director Health Services", department: "Health & Family Welfare", resolutionRate: 94, avgResolutionTime: 3.8, activeComplaints: 1, completedComplaints: 36, rating: 4.7 },
      { id: "OFF-007", name: "Shri Himanshu Gupta (IAS)", designation: "Director of Education", department: "Education Department", resolutionRate: 91, avgResolutionTime: 4.0, activeComplaints: 2, completedComplaints: 31, rating: 4.6 },
      { id: "OFF-008", name: "Er. R.K. Bhardwaj", designation: "Chief Engineer", department: "PWD & Infrastructure", resolutionRate: 83, avgResolutionTime: 5.4, activeComplaints: 5, completedComplaints: 29, rating: 4.0 },
      { id: "OFF-009", name: "Smt. Isha Khosla (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "Central Delhi", resolutionRate: 89, avgResolutionTime: 4.5, activeComplaints: 3, completedComplaints: 26, rating: 4.3 },
      { id: "OFF-010", name: "Shri Santosh Kumar (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "North West Delhi", resolutionRate: 87, avgResolutionTime: 4.9, activeComplaints: 4, completedComplaints: 23, rating: 4.2 },
      { id: "OFF-011", name: "Shri Pradeep Kumar (IAS)", designation: "District Magistrate", department: "Revenue & Grievance", district: "East Delhi", resolutionRate: 90, avgResolutionTime: 4.3, activeComplaints: 2, completedComplaints: 27, rating: 4.4 }
    ]);
    ...
    await GeneralMetric.create([
      ...
      // Citizen Dashboard KPIs
      { key: "citizen_registered_count", value: "1245" },
      { key: "active_applications_count", value: "84" },
      { key: "benefit_delivery_rate", value: "94.2" },
      { key: "funds_disbursed_fy25", value: "4.8" },
      { key: "national_performance_index", value: "91.4" },
      { key: "total_resolved_complaints", value: "842" },
      { key: "performance_target_pct", value: "92" },
      { key: "active_schemes_count", value: "124" },
      { key: "enrolled_citizens", value: "1045" },
      { key: "eligible_citizens", value: "2480" },
      // Monthly fund disbursement chart (JSON array)
      { key: "fund_chart_data", value: JSON.stringify([
    ...
    console.log('Seeded digital files.');
    ...
    // 8. Seed Welfare Applications
    await WelfareApplication.create([
      { citizen: 'Rahul Kumar', scheme: 'CM Widow Pension Scheme', doc: 'Income Certificate', status: 'Pending' },
      { citizen: 'Sunita Devi', scheme: 'Delhi Ladli Scheme', doc: 'Birth Certificate', status: 'Pending' },
      { citizen: 'Mohan Lal', scheme: 'Mukhyamantri Tirth Yatra Yojana', doc: 'Age Proof Certificate', status: 'Pending' },
    ]);
    console.log('Seeded welfare applications.');
